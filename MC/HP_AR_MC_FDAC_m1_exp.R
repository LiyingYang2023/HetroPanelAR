...
#### Parameter values
##############################################################################
rep = 2000 # number of replications in each experiment for each sample size
reps = 1:rep
NumPara = 3
...
##############################################################################
#### Exp 1: Heterogeneous AR panels under different initialization (M_i = 100, 3, 1)
##############################################################################
...
##############################################################################
#### Exp 2: Heterogeneous AR panels under different error processes (M_i = 100)
##############################################################################
init = 1; m0 = 100; b = 1; kappa = 2;
for (g in 2:dim(ng)[1]) {
...
##############################################################################
#### Exp 3: Homogeneous AR panels under different error processes (M_i = 100)
##############################################################################
init = 1; m0 = 100; b = 1; kappa = 2;
for (g in 1:dim(ng)[1]) {
  GAUSSIAN = ng[g,1]; GARCH = ng[g,2]
